  ...
  return (
    <>
      ...
      <NotBuiltYet
        ...
        why="The platform currently pays a fixed daily return on investment packages rather than executing trades, so there is no order book to display. This screen is reserved for when a broker or exchange integration is added."
      />
    </>
  );
}
