...
export const metadata: Metadata = {
  ...
  description:
    'FortuneX is a trading and affiliate platform: a daily trade bonus on invested capital, a thirty-level network, executive ranks and the Roaming Club — settled in USDT on BEP-20.',
  openGraph: {
