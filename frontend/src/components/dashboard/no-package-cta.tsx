...
export function NoPackageCta() {
  return (
    <section className="flex flex-wrap items-center justify-between gap-x-4 gap-y-3 rounded-[18px] border border-gold-line/25 bg-[linear-gradient(135deg,rgba(200,155,44,0.09)_0%,rgba(200,155,44,0.035)_100%)] p-5">
      <div className="flex min-w-0 items-start gap-3">
        <span className="grid h-10 w-10 shrink-0 place-items-center rounded-[12px] bg-gold/15 text-[var(--color-gold-on-soft)] ring-1 ring-inset ring-gold-line/25">
