      ...
      <div className="grid flex-1 grid-cols-2 gap-2.5 px-5 pb-5 sm:grid-cols-3 xl:grid-cols-2 2xl:grid-cols-3">
        {ACTIONS.map(({ label, href, Icon }) => (
          <Link key={label} href={href}
                className="group flex flex-col items-center justify-center gap-2 rounded-[5px] border border-line bg-card px-2 py-3.5 text-center transition-all duration-200 hover:-translate-y-0.5 hover:border-violet/30 hover:bg-violet-soft/40 hover:shadow-[0_8px_20px_-10px_rgba(96,70,232,0.4)]">
            <span className="grid h-9 w-9 place-items-center rounded-[4px] bg-violet-soft text-violet transition group-hover:bg-violet group-hover:text-white">
